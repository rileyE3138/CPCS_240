...
public UserInputCommand PromptUser(Scanner Input) {
	...
	//prevents crash since if the length is 0 .charAt(0) will fail
	...
	case "d":
		...
		* they are showed their input mistake in DropCommands fail condition
		*/
		if(input.length() < 3) {
			input += "\u200e\u200e\u200e";
		}
...
public Campus setUpCampus(Scanner reader) {
	...
	/*
	 * PROCESSES CAMPUS NAME + LOCATIONS/Sets Starting/Cur Loc
	 */
